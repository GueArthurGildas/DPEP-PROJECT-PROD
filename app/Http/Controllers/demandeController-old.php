...
class demandeController extends Controller
{
    ...
    /******************************************************/
    /******************************************************/
    //la fonction pour uploader les fichiers pdf uploader par l'user//
    /******************************************************/
    /******************************************************/
    ...
    public function storeFile(Request $request){
        ...
        if ($request->hasFile('fichier')) {
            ...
            dd($file );
            //$path = $file->store('uploads'); // Stocker le fichier dans le répertoire 'uploads'
    
            //return response()->json(['success' => 'Fichier téléchargé avec succès', 'path' => $path]);
        }
    }
