                                        ...
                                        <div class="nk-block-between-md g-4">
                                            ...
                                            <div class="nk-block-head-content">
                                                <ul class="nk-block-tools gx-3">
                                                    <li class="order-md-last"><a href="{{route("home.demandes.presentDemande.index")}}" class="btn btn-white btn-dim btn-outline-dark"><span>Nouvelle Demande</span><em class="icon ni ni-arrow-long-right"></em></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
