      ...
      <div class="card-inner">
         <form action="#">
            <div class="form-group">
               <label class="form-label" for="full-name">Nom du Navire</label>
               <div class="form-control-wrap">
                  <input type="text" class="form-control" id="full-name">
               </div>
            </div>
            <div class="form-group">
               <label class="form-label" for="email-address">IRCS</label>
               <div class="form-control-wrap">
                  <input type="text" class="form-control" id="email-address"  wire:model.debounce="VariableTestForBinding">
               </div>
            </div>

                                                        <div class="form-group">
                                                            <label class="form-label">Etat Pavillon</label>
                                                            <div class="form-control-wrap">
            ...
            <div class="form-group">
               <label class="form-label" for="email-address">ID Certificat</label>
               <div class="form-control-wrap">
...
<div class="col-lg-6">
   <div class="card card-bordered h-100">
      <div class="card-inner">
         <form action="#">
            <div class="form-group">
               <label class="form-label" for="cf-full-name">OMI</label>
               <input type="text" class="form-control" id="cf-full-name">
            </div>
            <div class="form-group">
               <label class="form-label" for="cf-email-address">ID Externe</label>
               <input type="text" class="form-control" id="cf-email-address">
            </div>
                                                            <div class="form-group">
                                                                <label class="form-label" for="pay-amount">Longueur</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="pay-amount">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label" for="pay-amount">Largeur</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="number" class="form-control" id="pay-amount">
                                                                </div>
                                                            </div>                                                            
            <div class="form-group">
               <label class="form-label" for="cf-subject">ORGP</label>
               <input type="text" class="form-control" id="cf-subject">
            </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Tiran d'eau</label>
                                                            <div class="form-control-wrap">
                                                                <select class="form-select js-select2" data-search="on">
                                                                    <option value="default_option">Default Option</option>
                                                                    <option value="option_select_name">Option select name</option>
