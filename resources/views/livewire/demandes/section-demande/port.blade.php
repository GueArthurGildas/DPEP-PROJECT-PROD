                                                ...
                                                <div class="row g-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                {{-- <input type="text" class="form-control form-control-lg"> --}}
                                                                 <select id="myTestSelect"  class="form-select-lg js-select2 form-control form-control-lg" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                               <select    id="objetPortSelect"  class="form-select js-select2" multiple="multiple" data-placeholder="Select Multiple options" >
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control" wire:model.prevent="test">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
