   ...
   <div class="nk-block">
      <div class="row g-gs">
         <div class="col-lg-3 col-xl-3 col-xxl-3 ">
            <div class="card card-bordered m-4">
               <div class="card card-bordered">
                  <div class="card-header border-bottom text-white" style="background-color:#df6d14" >Featured</div>
            ...
            <div class="card card-bordered m-4">
               <div class="card card-bordered">
                  <div class="card-header border-bottom text-white bg-danger" >Featured</div>
                  <ul class="link-list-opt no-bdr">
                     <li><a href="#"><em class="icon ni ni-setting"></em><span>Navire </span></a></li>
                     <li><a href="#"><em class="icon ni ni-notify"></em><span>Port d'Accueil</span></a></li>
                     <li><a href="#"><em class="icon ni ni-activity-alt"></em><span>Captures</span></a></li>
         ...
         <div class="col-lg-9 col-xl-9 col-xxl-9" >
            <div class="nk-block-head-sub"><a class="back-to text-danger" href="{{route('home')}}" ><em class="icon ni ni-arrow-left"></em><span>Retour</span></a></div>
            ...
            <form class="nk-stepper stepper-init is-alter" action="#" id="stepper-survey-v2" style="background*color:orange">
               <div class="nk-stepper-content ">
                  <div class="nk-stepper-progress stepper-progress mb-4 ">
                     <div class="stepper-progress-count mb-2 text-danger">de {{$idDemadne}}</div>
