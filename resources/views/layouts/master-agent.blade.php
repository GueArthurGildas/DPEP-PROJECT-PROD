...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                            ...
                            <div class="nk-footer-links">
                                <ul class="nav nav-sm">
                                    <li class="nav-item dropup">
                                        <a href="#" class="dropdown-toggle dropdown-indicator has-indicator nav-link text-base" data-bs-toggle="dropdown" data-offset="0,10"><span>CI - 00225</span></a>
                                        
                                    </li>
                                    <li class="nav-item">
                                        <a data-bs-toggle="modal" href="#region" class="nav-link"><em class="icon ni ni-globe"></em><span class="ms-1">Autres Infos</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script src="./assets/js/charts/chart-ecommerce.js?ver=3.2.2"></script>
     ...
     @include("code-js.js-agent-layout.accueil-js")  {{-- ici j'ajoute que les scripts en rapport avec le master page de l'agent portuaire --}}
</body>
